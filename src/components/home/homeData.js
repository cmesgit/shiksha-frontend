...
export const FEATURED_COURSES = [
  ...
  { cats: ["competitive", "all"], lvl: "Medical", ribbon: "Popular", stars: 5, count: 41, title: "NEET Preparation", fact: "Live + Recorded · Launching soon", tutor: "Dr. D. Ralte", avColor: "#0B5B3E", soon: true, grad: "rgba(236,78,134,0.72),rgba(193,58,104,0.88)", img: IMG("photo-1505751172876-fa1923c5c528"), icon: "pulse" },
  { cats: ["competitive"], lvl: "Civil Services", ribbon: null, stars: 4, count: 75, title: "UPSC & Civil Services", fact: "Live + Recorded · Launching soon", tutor: "K. Zoramthanga", avColor: "#FFB21D", soon: true, grad: "rgba(255,178,29,0.72),rgba(242,140,15,0.88)", img: IMG("photo-1554475900-0a0350e3fc7b"), icon: "institution" },
  { cats: ["competitive"], lvl: "Engineering", ribbon: null, stars: 5, count: 63, title: "IIT-JEE Preparation", fact: "Live + Recorded · Launching soon", tutor: "A. Sharma", avColor: "#E14D2A", soon: true, grad: "rgba(124,92,252,0.72),rgba(75,52,199,0.88)", img: IMG("photo-1614283226124-5a2f0f23752b"), icon: "target" },
  { cats: ["competitive"], lvl: "SSC · Banking", ribbon: null, stars: 4, count: 54, title: "Government Exams", fact: "Live + Recorded · Launching soon", tutor: "T. Lalhmingthanga", avColor: "#12b3a6", soon: true, grad: "rgba(20,184,160,0.72),rgba(11,91,62,0.88)", img: IMG("photo-1584982751601-97dcc096659c"), icon: "bank" },
  { cats: ["competitive"], lvl: "NDA · CDS", ribbon: null, stars: 4, count: 38, title: "Defence Exams", fact: "Live + Recorded · Launching soon", tutor: "Maj. R. Singh (Retd.)", avColor: "#3b82f6", soon: true, grad: "rgba(59,130,246,0.72),rgba(29,78,216,0.88)", img: IMG("photo-1590821091890-bdcc3c1e2b37"), icon: "shield" },
  ...
  { cats: ["competitive"], lvl: "Olympiads", ribbon: null, stars: 4, count: 29, title: "Olympiad & Foundation", fact: "Live + Recorded · Launching soon", tutor: "R. Vanlalhriati", avColor: "#FF7A45", soon: true, grad: "rgba(255,122,69,0.72),rgba(225,77,42,0.88)", img: IMG("photo-1741699428220-65f37f3fbbcb"), icon: "medal" },
];
