...
export default function MobileAudioGate() {
  ...
  return (
    <button
      ...
      onClick={enable}
      style={{
        // Anchored to the TOP of the viewport, not the bottom — the room's
        // control bar (mic/camera/leave) always sits at the bottom, and a
        // bottom-fixed banner here would paint over it on exactly the mobile
        // devices where autoplay-blocking (and so this banner) is common.
        position: "fixed",
        left: 0,
        right: 0,
        top: 0,
